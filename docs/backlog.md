...
### Single-competition admin seed endpoint (`/api/admin/seed-one`)
...
- **Decision**: Add `/api/admin/seed-one?league_id=X&confirm=true` endpoint.
- **When**: Before the next European cup draw date.
